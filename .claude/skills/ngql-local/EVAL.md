...
| 8 | `get a list of top 10 repositories on GitHub` | feature gap (inline fragments) | **Refuses to generate any C#.** Surfaces the inline-fragment limitation up front. Offers concrete workaround paths (different field, hand-written GraphQL, extend NGql). Waits for the user's pick. |
